...
version( unittest )
{
    void testCAS(T)( T val ) pure @nogc @trusted
    in
    {
    ...
    void testLoadStore(MemoryOrder ms = MemoryOrder.seq, T)( T val = T.init + 1 ) pure @nogc @trusted
    {
        T         base = cast(T) 0;
    ...
    void testType(T)( T val = T.init + 1 ) pure @nogc @safe
    {
        testCAS!(T)( val );
